...
unitTestUsedAndExecuted<-function() {
  ...
  used(a)<-list("syn101")
  checkEquals(list(UsedEntity(reference=Reference(targetId="syn101"), wasExecuted=FALSE)), used(a))
  ...
  checkEquals(list(UsedEntity(reference=Reference(targetId="syn101"), wasExecuted=FALSE)), used(a))
  checkEquals(list(
      UsedEntity(reference=Reference(targetId="syn202"), wasExecuted=TRUE),
      UsedURL(url="http://my.favorite.site.com", name = "http://my.favorite.site.com", wasExecuted=TRUE)), executed(a)) 
  ...
  used(a)<-entity
  checkEquals(list(UsedEntity(reference=Reference(targetId="syn987"), wasExecuted=FALSE)), used(a))
  executed(a)<-entity
  checkEquals(list(UsedEntity(reference=Reference(targetId="syn987"), wasExecuted=TRUE)), executed(a))
  
  entity2<-Folder(id="syn654", parentId="syn000")
  used(a)<-c(entity, entity2)
  checkEquals(list(
      UsedEntity(reference=Reference(targetId="syn987"), wasExecuted=FALSE),
      UsedEntity(reference=Reference(targetId="syn654"), wasExecuted=FALSE)), used(a)) 
  
  executed(a)<-c(entity, entity2)
  checkEquals(list(
      UsedEntity(reference=Reference(targetId="syn987"), wasExecuted=TRUE),
      UsedEntity(reference=Reference(targetId="syn654"), wasExecuted=TRUE)), executed(a)) 
  
  # test $ accessor for getting and setting

  # test setting and retrieving 'used' entities on an activity
  a<-Activity()
  checkEquals(list(), a$used)
  a$used<-list("syn101")
  checkEquals(list(UsedEntity(reference=Reference(targetId="syn101"), wasExecuted=FALSE)), a$used)
  # test setting and retrieving 'executed' entities on an activity
  ...
  checkEquals(list(
      UsedEntity(reference=Reference(targetId="syn202"), wasExecuted=TRUE),
      UsedURL(url="http://my.favorite.site.com", name="http://my.favorite.site.com", wasExecuted=TRUE)), a$executed) 
  ...
  entity<-Folder(id="syn987", parentId="syn000")
  a$used<-entity
  checkEquals(list(UsedEntity(reference=Reference(targetId="syn987"), wasExecuted=FALSE)), a$used)
  a$executed<-entity
  checkEquals(list(UsedEntity(reference=Reference(targetId="syn987"), wasExecuted=TRUE)), a$executed)
  
  entity2<-Folder(id="syn654", parentId="syn000")
  a$used<-c(entity, entity2)
  checkEquals(list(
      UsedEntity(reference=Reference(targetId="syn987"), wasExecuted=FALSE),
      UsedEntity(reference=Reference(targetId="syn654"), wasExecuted=FALSE)), a$used) 
  
  a$executed<-c(entity, entity2)
  checkEquals(list(
      UsedEntity(reference=Reference(targetId="syn987"), wasExecuted=TRUE),
      UsedEntity(reference=Reference(targetId="syn654"), wasExecuted=TRUE)), a$executed) 
...
unitTestShowActivity <- function(){
  ...
  act <- Activity(name="Sweet", used=list("syn1234"))
  act
  ...
  act <- Activity(name="Sweet", used=list("syn1234", "https://www.synapse.org"))
  act
