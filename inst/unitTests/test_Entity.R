...
unitTestUsedAndExecuted<-function() {
  ...
  used(a)<-list("syn101")
  checkEquals(list(list(reference=list(targetId="syn101"), name="syn101", wasExecuted=FALSE, 
  ...
  checkEquals(list(list(reference=list(targetId="syn101"), name="syn101", wasExecuted=FALSE, 
        concreteType="org.sagebionetworks.repo.model.provenance.UsedEntity")), used(a))
  checkEquals(list(
      list(reference=list(targetId="syn202"), name="syn202", wasExecuted=TRUE, 
  ...
  used(a)<-entity
  checkEquals(list(list(reference=list(targetId="syn987"), name="syn987", wasExecuted=FALSE, 
        concreteType="org.sagebionetworks.repo.model.provenance.UsedEntity")), used(a))
  executed(a)<-entity
  checkEquals(list(list(reference=list(targetId="syn987"), name="syn987", wasExecuted=TRUE, 
  ...
  checkEquals(list(
      list(reference=list(targetId="syn987"), name="syn987", wasExecuted=FALSE, 
        concreteType="org.sagebionetworks.repo.model.provenance.UsedEntity"),
      list(reference=list(targetId="syn654"), name="syn654", wasExecuted=FALSE, 
        concreteType="org.sagebionetworks.repo.model.provenance.UsedEntity")), used(a)) 
  
  executed(a)<-c(entity, entity2)
  checkEquals(list(
      list(reference=list(targetId="syn987"), name="syn987", wasExecuted=TRUE, 
        concreteType="org.sagebionetworks.repo.model.provenance.UsedEntity"),
      list(reference=list(targetId="syn654"), name="syn654", wasExecuted=TRUE, 
        concreteType="org.sagebionetworks.repo.model.provenance.UsedEntity")), executed(a)) 
